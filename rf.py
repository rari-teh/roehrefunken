...
dlp_video = {'format': 'bestvideo[height<=720]+bestaudio/best', 'postprocessors': [{'key': 'FFmpegCopyStream',}], 'postprocessor_args': {'CopyStream': ['-c:v', 'libx264', '-c:a', 'copy', '-f', 'mp4'],}, 'outtmpl': '%(title)s.%(ext)s', 'noplaylist': True, 'quiet': True,}
